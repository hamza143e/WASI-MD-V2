let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `MR DEVELOPER SHAHZADA 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊:* https://whatsapp.com/channel/0029VaVPRZnK0IBbWek2rr1z\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `MR DEVELOPER SHAHZADA 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://whatsapp.com/channel/0029VaVPRZnK0IBbWek2rr1z \n\n ${Config.botname} *WORKS*`;
